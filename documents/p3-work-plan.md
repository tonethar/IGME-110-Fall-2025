...
- Due dates for project deliverables
  ...
  - ***11B - Interactive Prototype: LoFi Testing*** (deliverable #2) - need *site map* and *mockups* of at least 3 screens for testing - and user flow diagrams for at least 3 use cases -  due 11B (11/5 or 11/6)
  - ***12A - Interactive Prototype:  Hi-Fi Version*** and in-class testing of interactive digital prototype (Figma, Google Slides, HTML/CSS/JS, Visual Studio etc) aka (deliverable #3)  - due 12A (11/10 or 11/11)
