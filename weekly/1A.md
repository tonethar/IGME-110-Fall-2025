...
- Project 3 - App Prototype (different group)
  - Tools used: Google Slides, Figma, Axure, Canva or "real code" (Unity, HTML5/JavaScript)
- Project 4 - Promotional Video (solo)
  - Tools used: Adobe Premiere, [Shotcut](https://www.movavi.com/learning-portal/shotcut-review.html), [OBS](https://restream.io/learn/what-is/obs), [Audacity](https://www.audacityteam.org/download/)
