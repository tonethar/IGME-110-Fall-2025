...
- Get the credit you deserve - post a message to your section-specific Slack channel, in the thread named *Paper Prototype of Digital Game In-class Exercise - POST HERE* - be sure to give us (one post per team):
  ...
  - 3 --> briefly discuss - the time scale of the game (slow, real-time, fast), the actions (choices) your players can take, the emotions you hope they feel, and at least one emergent aspect of the game as it is played (dynamics) 
