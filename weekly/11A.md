...
# TODAY'S GOAL - UNDERSTANDING WHAT YOU NEED FOR THE NEXT PROJECT 3 DELIVERABLE ...
## ... WHICH IS DUE BEFORE OUR NEXT CLASS MEETING
...
- Get inspired! Think about the screens and navigation systems from some popular apps:
  ...
  - Google Maps
    - has a global navigation system that links to 5 main categories (pages)
      ...
      - Contribute
      - Updates
    - there is a Search box on the top of both Explore and Go pages
...
- QUESTIONS?
  - during class, ASK
  - there's paper for prototyping, and Halloween candy, on the back table
