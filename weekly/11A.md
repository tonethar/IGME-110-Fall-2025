...
- For deliverable #2, you are going to look at each user persona
  ...
  - and write them down
- You will then create user flow diagrams for each user - at least 5 for your *primary user*, and at least two more each for your *power user* and *casual user*
...
- Translate our User Flow diagrams into app "screens" that map to "user flows" created above
- TODO
 
---

## V. BTW - Why User Testing?
...
- Prepare for the test:
  ...
  - use one sheet of paper for each screen - we will be doing "Scenario-Based Usability Testing"
  - create an "under construction" page for any time a user clicks on a link or button to something you haven't implemented yet
  ...
  - assign the 3 roles for the testers:
    ...
    - *Scribe* - writes down responses on form
- Create the tests:
  - use a version of the [provided form testing template](../documents/p3-wireframe-feedback-form.md)
...
- Here are the techniques we'll be using, see the form template linked above
